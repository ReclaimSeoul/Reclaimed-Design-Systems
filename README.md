...
| ![plastic bottles with multi purpose](systems/plasticbottles/00_thumb.jpg) | [plastic bottles with multi purpose](systems/plasticbottles/)<br><br>A system for reusing bottles with different sizes<br><br>by Seunghyuk Hyun, Jahan<br>[aggregation.json](systems/plasticbottles/aggregation.json) · [meta.json](systems/plasticbottles/meta.json) |
