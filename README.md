...
| ![plastic bottles with multi joint](systems/plasticbottles/00_thumb.jpg) | [plastic bottles with multi joint](systems/plasticbottles/)<br><br>A system for reusing bottles with different sizes<br><br>by Seunghyuk Hyun, Jahan<br>[aggregation.json](systems/plasticbottles/aggregation.json) · [meta.json](systems/plasticbottles/meta.json) |
| ![plastic bottles chain](systems/plasticchain/00_thumb.jpg) | [plastic bottles chain](systems/plasticchain/)<br><br>A system for reusing bottles with different sizes<br><br>by Seunghyuk Hyun, Jahan<br>[aggregation.json](systems/plasticchain/aggregation.json) · [meta.json](systems/plasticchain/meta.json) |
